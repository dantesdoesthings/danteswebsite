"""
Django settings for dantes_site project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dantes_site.context_processors.site_globals',
            ],
        },
    },
]

WSGI_APPLICATION = 'dantes_site.wsgi.application'
...
DATABASES = {
    'default': secrets.DATABASE_DEFAULT
}
